#gera quatro diferentes formas de pulso para sinalização PAM quatro níveis
import numpy as np
from matplotlib import pyplot as plt
from function_utils import prz, pnrz, psine, prcos
from eyediagram import eyediagram

data = np.sign(np.random.randn(400)) + 2*(np.sign(np.random.randn(400))) # gera 400 bits aleatórios de 4 níveis
...
# salva as figuras
fig1.savefig('images/mary_eyediagram_RZ.png')
fig2.savefig('images/mary_eyediagram_NRZ.png')
fig3.savefig('images/mary_eyediagram_senoide.png')
fig4.savefig('images/mary_eyediagram_cosseno.png')